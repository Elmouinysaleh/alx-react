...
```console
saleh@vagrant:~$ curl -sL https://deb.nodesource.com/setup_12.x -o nodesource_setup.sh
saleh@vagrant:~$ sudo bash nodesource_setup.sh
saleh@vagrant:~$ sudo apt install nodejs -y
```

### Check version

```console
saleh@vagrant:~$ nodejs -v
v12.22.1
saleh@vagrant:~$ npm -v
6.14.12
```
